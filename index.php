<?php 
    // My Home Work one.
    echo "<h1>1. echo and print difference in php.</h1>";
    echo "<h3>Echo example</h3>";
    echo "<li>Echo can pass multiple string separated as (,).</li> <br>";
    echo "<li>Echo dosen't return any value.</li> <br>";
    echo "<li>Echo is faster than print.</li> <br>";
    echo "<li>In PHP, echo is not function but a language construct.</li> <br>";

    echo "<h3>Print example</h3>";
    echo "<li>Using print dosen't multiple argument.</li> <br>";
    echo "<li>print Always return value 1</li> <br>";
    echo "<li>it is slower then echo.</li> <br>";
    echo "<li>print is not a really function but a language construct. However, it behaves like a function it that it returns a value.</li> <br>";
